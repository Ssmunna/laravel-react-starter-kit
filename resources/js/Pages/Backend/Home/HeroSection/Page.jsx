            ...
            <div className="flex items-center justify-between border-b border-gray-300 p-5 border border-gray-300 rounded mt-5">
                <div className="w-full">
                    <form onSubmit={handleSubmitForm} className={`w-full space-y-2`}>
                        ...
                        <div className="form-control">
                            <label htmlFor="button_text" className={`label`}>Button Text <span className={`text-xs text-red-600`}>*</span></label>
                            <input type="text" id={`button_text`} value={data.button_text} onChange={handleTextInput} className={`input`} placeholder={`Enter button text`}/>
                        </div>
